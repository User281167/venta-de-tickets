    ...
    it('creates preference with correct shape', async () => {
      ...
      expect(mockPreferenceCreate).toHaveBeenCalledWith({
        body: {
          ...
          back_urls: {
            success: 'https://frontend.test/mi-cuenta/tiquetes/state/success',
            failure: 'https://frontend.test/mi-cuenta/tiquetes/state/failure',
            pending: 'https://frontend.test/mi-cuenta/tiquetes/state/pending',
          },
          notification_url: 'https://api.test/api/payments/webhook/mercadopago',
