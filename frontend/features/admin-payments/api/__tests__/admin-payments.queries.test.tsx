...
describe("usePaymentDetail", () => {
  ...
  it("fetches payment detail by id", async () => {
    const mockDetail = { id: "p1", subtotalCents: 5000, totalCents: 5000, status: "completed", provider: "mp", providerTxId: null, createdAt: "", updatedAt: "", userId: "u1", user: { id: "u1", email: "a@b.com", fullName: "Ana" }, tickets: [] };
