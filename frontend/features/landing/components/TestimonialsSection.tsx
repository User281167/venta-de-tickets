...
const TESTIMONIALS = [
  {
    icon: IconQuote,
    quote:
      "Volver a la U con esta energia cambia la forma de imaginar el futuro.",
    author: "Egresada UTP",
  },
  {
    icon: IconUsers,
    quote: "El networking conecto generaciones, empresas y proyectos reales.",
    author: "Participante 2025",
  },
  {
    icon: IconWorld,
    quote: "Una convencion con mirada global y raiz universitaria.",
          ...
          {TESTIMONIALS.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <Text color="brand.light" lineHeight="1.8">
