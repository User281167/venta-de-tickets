...
const AGENDA_ITEMS = [
  ...
  {
    time: "14:30",
    title: "Charlas simultáneas (IA, negocios, innovación)",
    icon: IconRocket,
  },
  {
    time: "17:00",
    title: "Cierre inspiracional y sorteo de becas",
    icon: IconClock,
  },
];
...
export function AgendaSection() {
  return (
    <Box id="agenda" py={20}>
      <Container maxW="800px" px={4} color="white">
        <Stack gap={3} align="center" mb={12}>
          <Heading as="h2" size={{ base: "2xl", md: "3xl" }} textAlign="center">
            Programa del día
          </Heading>
